...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Reach Sphinovex for AI-driven drug discovery, computational biology and CRO collaborations." },
        ...
        <div className="mx-auto max-w-6xl px-6 grid lg:grid-cols-5 gap-10">
          <div className="lg:col-span-3 rounded-3xl border border-border bg-card p-8 shadow-elegant">
            {sent ? (
              ...
              >
                ...
                <Field label="Topic" name="topic" placeholder="e.g. Molecular dynamics for kinase target" />
                <div>
          ...
          <aside className="lg:col-span-2 space-y-5">
            <div className="rounded-3xl border border-border bg-card p-6">
              ...
              <a href="mailto:info@sphinovex.com" className="mt-2 block font-display text-lg text-ink hover:text-primary">
                info@sphinovex.com
              </a>
            </div>
            <div className="rounded-3xl border border-border bg-card p-6">
              ...
              >
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-primary text-primary-foreground">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20.45 20.45h-3.55v-5.57c0-1.33-.02-3.04-1.85-3.04-1.86 0-2.14 1.45-2.14 2.95v5.66H9.36V9h3.41v1.56h.05c.47-.9 1.63-1.85 3.36-1.85 3.59 0 4.27 2.36 4.27 5.43v6.31zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zM7.12 20.45H3.56V9h3.56v11.45zM22.22 0H1.77C.79 0 0 .77 0 1.72v20.55C0 23.23.79 24 1.77 24h20.45c.98 0 1.78-.77 1.78-1.73V1.72C24 .77 23.2 0 22.22 0z"/></svg>
                </span>
                LinkedIn
              </a>
            </div>
...
function Field({ label, name, type = "text", required, placeholder }: {
  ...
  return (
    <div>
      <label htmlFor={name} className="block text-xs font-medium text-ink mb-2">{label}</label>
      <input
        id={name}
        name={name}
        type={type}
