      ...
      <div className="mx-auto max-w-[1800px] px-8 lg:px-12 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm text-muted-foreground">
            A computational research and AI-driven CRO accelerating drug discovery,
            molecular modeling and pharmaceutical innovation.
          </p>
          <a
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="mailto:info@sphinovex.com" className="hover:text-ink">Email</a></li>
          </ul>
        </div>
      </div>
